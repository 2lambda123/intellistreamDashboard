...
topWellsContainer = new Layer
	y: kpisContainer.height + 60, x: timeseriesContainer.width
...
facetedPanelBuild = ->
	...
	gasLiftCounter = new Layer
		parent: facetContainer
		width: 85, height: 25, x: 196, y: 330
		color: blue05
		backgroundColor: null
		clip: true
...
type_wrapper = new Layer
	width: 690, height: 30
	x: headerBar.width/3.3, y: headerBar.height + 30, z: 100
	opacity: 0
	backgroundColor: "white"
